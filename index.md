...
address: "Room of Rememberence, Baker Library"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
country: "us"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes) for the institution that hosts the workshop
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) for the workshop
latitude: "43.705359"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-72.288688"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "2025-08-01"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "09:00 - 17:00 (EST)"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2025-08-01      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2025-08-02       # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["sooks one", "sooks two"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
what3words: follows.party.applause         # optional: what3words (https://what3words.com) address of the workshop venue, without leading slashes e.g. "globe.lessening.computers"
---
